package com.tc.reggie.controller;
...
public class EmployeeController {
    ...
    public R<Employee> login(HttpServletRequest request,@RequestBody Employee employee){
        ...
        //如果没有查询到则返回登录失败结果
        if(emp==null) return R.error("登陆失败,用户名未注册");

        //密码比对，如果不一致则返回登陆失败结果
        if(!emp.getPassword().equals(password)) return R.error("登陆失败，密码错误");

        //查询用户状态，如果已禁用，则返回员工已禁用结果
